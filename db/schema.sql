...
CREATE TABLE IF NOT EXISTS listings (
  ...
  toilets          TINYINT UNSIGNED NOT NULL DEFAULT 0,
  sqm              INT UNSIGNED NOT NULL DEFAULT 0,
  `condition`      VARCHAR(80)  DEFAULT NULL,
  title_type       VARCHAR(120) DEFAULT NULL,
  parking          VARCHAR(120) DEFAULT NULL,
  ...
  -- Investment ratings (1–5)
  inv_capital_appreciation  TINYINT UNSIGNED DEFAULT NULL,
  inv_rental_demand         TINYINT UNSIGNED DEFAULT NULL,
  inv_shortlet_potential    TINYINT UNSIGNED DEFAULT NULL,
  inv_accessibility         TINYINT UNSIGNED DEFAULT NULL,
  inv_liquidity             TINYINT UNSIGNED DEFAULT NULL,
  inv_luxury_appeal         TINYINT UNSIGNED DEFAULT NULL,
  inv_family_friendly       TINYINT UNSIGNED DEFAULT NULL,
  inv_roi                   TINYINT UNSIGNED DEFAULT NULL,
  -- Investment outlook
  inv_capital_growth        VARCHAR(80) DEFAULT NULL,
  inv_rental_demand_outlook VARCHAR(80) DEFAULT NULL,
  inv_shortlet_demand       VARCHAR(80) DEFAULT NULL,
  inv_future_appreciation   VARCHAR(80) DEFAULT NULL,
  inv_recommendation        VARCHAR(80) DEFAULT NULL,
  -- Lifestyle & targeting
  lifestyle_benefits        TEXT DEFAULT NULL,
